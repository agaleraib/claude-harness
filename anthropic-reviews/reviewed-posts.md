...
| 2026-04-23 | Anthropic and Amazon expand collaboration for up to 5 gigawatts of new compute | https://www.anthropic.com/news/anthropic-amazon-compute | skipped | Compute-partnership / infrastructure announcement (5GW AWS, $100B commit, Claude Platform on AWS). No harness-facing surface — no Claude Code, SDK, skills, or agent tooling content. |
| 2026-04-23 | Anthropic expands partnership with Google and Broadcom | https://www.anthropic.com/news/google-broadcom-partnership-compute | skipped | TPU/compute deal (3.5GW via Google Cloud + Broadcom, online 2027). Pure infrastructure; no implications for a local coding harness. |
| 2026-04-23 | Announcing the Anthropic Economic Index Survey | https://www.anthropic.com/research/economic-index-survey-announcement | skipped | Monthly survey methodology for measuring AI's economic impact via Anthropic Interviewer. Research-methodology post; nothing actionable for harness skills/agents/profile. |
