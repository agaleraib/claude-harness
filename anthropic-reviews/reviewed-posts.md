...
| 2026-04-22 | Anthropic and Amazon expand collaboration for up to 5 gigawatts of new compute | https://www.anthropic.com/news/anthropic-amazon-compute | skipped | Infrastructure/financing announcement (5 GW Trainium capacity, $5B–$25B Amazon investment, full Claude Platform on AWS). No harness-side change — the AWS-bundled Claude Platform is a hosting surface that the existing `claude` CLI already targets via standard env vars. |
| 2026-04-22 | Anthropic STEM Fellows Program | https://job-boards.greenhouse.io/anthropic/jobs/5189848008 | skipped | Careers/fellowship announcement (in-person SF, June–Sept 2026, PhD-level domain experts). Not on the tracked news/engineering/research/resources surfaces, no harness-facing artifact. |
